...
These boundaries are requirements in negative form. Changing one requires a
dedicated agreement pull request.

- **NG-001:** Do not make this repository a Claude or GitHub Copilot
  compatibility bundle. Those platforms have separate comparison templates.
- **NG-002:** Do not require identical file layouts across the comparison
...
- **NG-008:** Do not weaken, skip, or delete an acceptance test to complete a
  Task. Replan or escalate instead.
- **NG-009:** Do not enable a ruleset, auto-merge policy, or GitHub Template
  setting without human review.
- **NG-010:** Do not include project-specific product code, commands, MCP
  credentials, organization names, or model pins in the generic template.
- **NG-011:** Do not solve release management, deployment strategy, or product
  governance beyond providing a traceable agent-work layer for them.
